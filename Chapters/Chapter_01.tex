...
\subsection{Location Intelligence \& Livability Analysis}  
\begin{itemize}  
    \item \textbf{Livability Scores:} Composite scoring for Transit, Walkability, and Schools
    \item \textbf{Risk Assessment:} Identify potential environmental risks such as flooding and noise pollution
\end{itemize}
