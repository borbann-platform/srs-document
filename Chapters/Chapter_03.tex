...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.4\textwidth}>{\raggedright\arraybackslash}p{0.6\textwidth}}
	...
	\end{itemize} \\
	\midrule
	\multicolumn{2}{l}{\textbf{Site Analysis \& Catchment}} \\
	\midrule
	As a business owner, I want to see a site score for a specific category (e.g., Cafe) to evaluate commercial potential &
	\begin{itemize}
	\item System provides a 0-100 score based on magnets and competition
	\item Analysis includes count of traffic drivers within 1km
	\end{itemize} \\
	
	\rowcolor[gray]{0.95}
	As a user, I want to visualize the 15-minute reachable area from a location to understand accessibility &
	\begin{itemize}
	\item Map displays an isochrone polygon for walking or driving
	\item Polygon overlay includes estimated population reach
	\end{itemize} \\
...
\begin{itemize}
	...
	\item \textbf{Interact with AI Agent}  
	      ...
	      \begin{itemize}
	      	\item \textit{Includes:} Site Analysis, Property Search
	      \end{itemize}
\end{itemize}
